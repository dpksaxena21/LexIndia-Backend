    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            return {
                "ok": True,
                "cnr": cnr,
                "case_number": case.get("filingNumber", case.get("caseNumber", "")),
                "case_type": case.get("caseTypeRaw", case.get("caseType", "")),
                "court": case.get("courtName", ""),
                "court_no": case.get("courtNo", ""),
                "state": case.get("state", ""),
                "judicial_section": case.get("judicialSectionRaw", ""),
                "status": case.get("caseStatus", case.get("disposalTypeRaw", "PENDING")),
                "purpose": case.get("purpose", ""),
                "last_hearing": case.get("lastHearingDate", ""),
                "next_hearing": case.get("nextHearingDate", case.get("nextHearing", "")),
                "judge": case.get("judgeName", case.get("judgeCode", [""])[0] if case.get("judgeCode") else ""),
                "petitioner": case.get("petitionerName", case.get("petitionerAdvocate", case.get("petitioner", ""))),
                "respondent": case.get("respondentName", case.get("respondentAdvocate", case.get("respondent", ""))),
